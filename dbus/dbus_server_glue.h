...
#ifndef __dbusxx___home_wolfv_Programs_suggestr_dbus_dbus_server_glue_h__ADAPTOR_MARSHAL_H
#define __dbusxx___home_wolfv_Programs_suggestr_dbus_dbus_server_glue_h__ADAPTOR_MARSHAL_H
...
public:
    ...
    virtual std::vector< std::string > Hello(const std::string& word, const std::vector< std::string >& prev_words) = 0;
...
private:
    ...
    ::DBus::Message _Hello_stub(const ::DBus::CallMessage &call)
    {
        ...
        std::vector< std::string > argout1 = Hello(argin1, argin2);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
...
#endif //__dbusxx___home_wolfv_Programs_suggestr_dbus_dbus_server_glue_h__ADAPTOR_MARSHAL_H
